...
import { packGrid, pixelToCell, findInsertionIndex } from "../../lib/form-engine/grid-engine";
import { cn } from "../../lib/utils/cn";

function GridBackground({ active }) {
  return (
    <div
      className={cn(
...
export function BuilderCanvas() {
  ...
  const [pointerCell, setPointerCell] = React.useState(null);

  const lastInsertionRef = React.useRef(null);
  ...
  if (activeDragId && insertion) {
    ...
    window._lastGridInsertionIndex = insertion.index;
  }
