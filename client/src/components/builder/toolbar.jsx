...
export function BuilderToolbar({ formId, status, onSaveSuccess }) {
  ...
  return (
    <div className="flex items-center justify-between border-b border-ink/10 bg-white px-4 py-2.5 dark:border-white/10 dark:bg-paper-darkdim">
      <div className="flex items-center gap-3">
        <Link to="/forms"><Button variant="ghost" size="icon"><ArrowLeft className="h-4 w-4" /></Button></Link>
        <input
          value={title}
      ...
      <div className="flex items-center gap-1.5">
        ...
        <AiGenerateButton />
        <Link to={`/forms/${formId}/versions`}><Button variant="ghost" size="sm"><History className="h-3.5 w-3.5" /> Versions</Button></Link>
