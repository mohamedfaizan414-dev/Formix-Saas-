...
export function PatientsTableList({ initialPatients, isSuperAdmin, hospitals, organizationId, onSuccess }) {
  ...
  React.useEffect(() => {
    if (organizationId && !form.hospitalId) {
      setForm((prev) => ({ ...prev, hospitalId: organizationId }));
    }
  }, [organizationId]);
  ...
  return (
    <div className="space-y-4 w-full">
      ...
      <Dialog open={isModalOpen} onClose={() => setIsModalOpen(false)} title="Register a new patient">
