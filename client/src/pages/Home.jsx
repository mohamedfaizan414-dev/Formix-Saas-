...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-paper dark:bg-paper-dark">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6 text-ink dark:text-white">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/login"><Button size="sm">Open builder</Button></Link>
        </div>
      </header>

      {/* HERO */}
      <section className="chart-paper relative mx-auto max-w-6xl overflow-hidden rounded-lg border border-ink/10 px-8 py-16 md:px-14 md:py-24 dark:border-white/10 text-ink dark:text-white">
        ...
        <p className="mt-6 max-w-xl text-lg text-ink-soft dark:text-white/60">
          ...
          consent, and paperwork — built by hospital admins, filled by clinicians,
          versioned like a chart.
        </p>
        <div className="mt-9 flex flex-wrap items-center gap-4">
          <Link to="/login"><Button size="lg">Start building<ArrowRight className="h-4 w-4" /></Button></Link>
          <Link to="/login"><Button size="lg" variant="outline">View a live form</Button></Link>
        </div>
      ...
      {/* CAPABILITIES */}
      <section id="capabilities" className="mx-auto max-w-6xl px-6 py-24 md:px-0 text-ink dark:text-white">
      ...
      {/* ROLES */}
      <section id="roles" className="mx-auto max-w-6xl px-6 pb-24 md:px-0 text-ink dark:text-white">
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 md:py-16">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-5">
            <div className="col-span-2 space-y-4 pr-0 md:pr-8">
              ...
              <p className="text-xs leading-relaxed text-ink-soft dark:text-white/55 max-w-sm">
                The unified clinical schema infrastructure and engine for electronic health records, dynamic medical workflows, and structural field rendering parameters.
              </p>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs text-ink-soft dark:text-white/60">
                ...
                <li><Link to="/login" className="hover:text-clinical-teal transition-colors">JSON Form Schema</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs text-ink-soft dark:text-white/60 font-medium">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs text-ink-soft dark:text-white/60 font-medium">
                <li><Link to="/login" className="hover:text-clinical-teal transition-colors">Sign In Portal</Link></li>
                <li><Link to="/login" className="hover:text-clinical-teal transition-colors">Initialize Schema</Link></li>
                <li><Link to="/login" className="hover:text-clinical-teal transition-colors">EHR Form Builder</Link></li>
              </ul>
            </div>
          </div>
