// components/dashboard/delete-hospital-dialog.tsx
"use client";
...
export function DeleteHospitalDialog({ hospitalId, hospitalName }: DeleteHospitalDialogProps) {
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} title="Confirm Permanent Deletion" className="w-full max-w-md p-4 sm:p-6">
        ...
        {/* Responsive, touch-friendly operational execution buttons */}
